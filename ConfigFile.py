...
config_list2.append({"filename": "oobd_control_C346.ini", "displayname": "C346"})  # index = 0 NEED TO TEST STILL!!!!
...
config_list2.append({"filename": "oobd_control_CD390.ini", "displayname": "CD390"})  # index = 3 NEED TO TEST STILL!!!!
config_list2.append({"filename": "oobd_control_CD391.ini", "displayname": "CD391"})  # index = 4 NEED TO TEST STILL!!!!
...
config_list2.append({"filename": "oobd_control_V408.ini", "displayname": "V408"})  # index = 7 hs 125k, panasonic, sp=1 abs=?
